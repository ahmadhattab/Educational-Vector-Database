...
مرحبًا بكم في مشروع **قاعدة المتجهات التعليمية** — مشروع مبسّط ومكتوب بلغة بايثون يهدف إلى شرح فكرة **Vector Databases** بطريقة واضحة وسهلة القراءة، بعيدًا عن التعقيد الموجود في الأنظمة الإنتاجية مثل Pinecone أو Milvus أو FAISS.
